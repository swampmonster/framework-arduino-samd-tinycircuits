...
void TwoWire::changeInterface(uint8_t wireInterface){
  ...
  transmissionBegun=false;
  if(wireInterface==0){
    this->sercom = &PERIPH_WIRE;
    this->_uc_pinSDA=PIN_WIRE_SDA;
    this->_uc_pinSCL=PIN_WIRE_SCL;
  }else if(wireInterface==1){
    this->sercom = &PERIPH_WIRE1;
    this->_uc_pinSDA=PIN_WIRE1_SDA;
    this->_uc_pinSCL=PIN_WIRE1_SCL;
  }else if(wireInterface==2){
    this->sercom = &PERIPH_WIRE2;
    this->_uc_pinSDA=PIN_WIRE2_SDA;
    this->_uc_pinSCL=PIN_WIRE2_SCL;
  }else if(wireInterface==3){
    this->sercom = &PERIPH_WIRE3;
    this->_uc_pinSDA=PIN_WIRE3_SDA;
    this->_uc_pinSCL=PIN_WIRE3_SCL;
  }
